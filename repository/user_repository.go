...
func (repository *userRepository) Create(entity *entity.UserEntity) error {
	...
	if err != nil {
		return errors.WrapCode(err, "unable to create user", errors.CodeUnavailable)
	}
	return nil
}
...
func (repository *userRepository) Update(entity *entity.UserEntity) error {
	...
	if err != nil {
		return errors.WrapCode(err, "unable to update user", errors.CodeUnavailable)
	}
...
func (repository *userRepository) ExistsByEmail(email string) (bool, error) {
	...
	if err != nil {
		return false, errors.WrapCode(err, "unable to get user", errors.CodeInternal)
	}
...
func (repository *userRepository) GetById(id int64) (*entity.UserEntity, error) {
	...
	if err != nil {
		return nil, errors.WrapCode(err, "unable to get user", errors.CodeUnavailable)
	}
...
func (repository *userRepository) GetByEmail(email string) (*entity.UserEntity, error) {
	...
	if err != nil {
		return nil, errors.WrapCode(err, "unable get get user", errors.CodeUnavailable)
	}
	return &user, nil
}
...
func (repository *userRepository) GetAll() ([]entity.UserEntity, error) {
	...
	if err != nil {
		return nil, errors.WrapCode(err, "unable get get users", errors.CodeUnavailable)
	}
	return users, nil
}
