...
func (repository *TournamentRepository) GetByIdGreaterThanAndNotDeleted(after int64, count int) ([]entities.TournamentEntity, error) {
...
func (repository *TournamentRepository) GetByDateGreaterThanEqualAndNotDeleted(minimumDate time.Time, limit int) ([]entities.TournamentEntity, error) {
	tournaments := []entities.TournamentEntity{}
...
func (repository *TournamentRepository) GetByDateLessThanAndNotDeleted(maximumDate time.Time, limit int) ([]entities.TournamentEntity, error) {
	tournaments := []entities.TournamentEntity{}
